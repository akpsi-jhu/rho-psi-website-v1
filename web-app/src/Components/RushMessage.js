...
const RushMessage = () => {
	...
	return (
        <Stack spacing = {3}  >
            <Box
                sx={{ width: 300, fontSize: 16, paddingX: 1, paddingY: 1.5, backgroundColor: '#F0F0F0', borderRadius: 85, fontWeight: 500, color: '#1F282C'
                }}>
